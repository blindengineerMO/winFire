...
const links=[['/','view-dashboard-outline','Overview'],['/inventory','server-network','Inventory'],['/directory','account-group-outline','Directory'],['/policies','source-branch','Policy Studio'],['/reports','chart-box-outline','Reports'],['/logs','text-box-search-outline','Event logs'],['/internet','web','Internet'],['/mapping','vector-link','Mapping'],['/identity','shield-account-outline','Identity'],['/admin','cog-outline','Administration']]
...
const enterpriseTitle=computed(()=>({'/':'Dashboard','/inventory':'Network / Assets','/directory':'Entities / Directory','/policies':'Network / Policies','/reports':'Reporting','/logs':'Network / Visibility','/internet':'Network / Internet','/mapping':'Network / Mapping','/identity':'Identity','/admin':'Administration'})[route.path]||title.value)
