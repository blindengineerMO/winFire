...
<template>
  <section class="wef-settings">
    ...
    <div class="inline-actions"><label class="switch-field"><span>Enable push receiver</span><input v-model="settings.enabled" type="checkbox" role="switch"><span class="switch-control" aria-hidden="true"></span></label><button class="button small primary" :disabled="busy||!settings.secretConfigured&&!sharedSecret&&!clearSecret" @click="save">Save receiver setting</button></div>
