...
const categories=[['policy_drift','Policy drift'],['verifier_failure','Verifier failure'],['mfa_challenge_failure','MFA challenge failure'],['agent_offline','Agent offline'],['node_unreachable','Node unreachable'],['security_policy','Security policy']]
