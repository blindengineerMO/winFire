...
10. Use Visibility → Mapping and Administration → Discovery for connection maps, ARP snapshots, CIDR probes, and optional credentialed SNMP switch/router polling. SNMP targets collect standard ARP and forwarding tables and automatically pass scoped IP candidates through node onboarding.
